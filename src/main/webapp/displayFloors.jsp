...
<body>
	...
	<% 
									...
									%><tr>	<td align="center"><a style="color:white; text-decoration:none" href="RoomServlet?richiesta=home&floorId=<% out.println(floors.get(i).getId()); %>"><% out.println(floors.get(i).getId()); %></a></td>
											...
											<td align="center"><a style="color:white; text-decoration:none" href="RoomServlet?richiesta=home&floorId=<% out.println(floors.get(i).getId()); %>"><% out.println(floors.get(i).getBuilding().getId()); %></a></td>
									</tr>
